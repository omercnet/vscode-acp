...
[![VS Code Marketplace](https://img.shields.io/visual-studio-marketplace/v/opencode.vscode-acp?style=flat-square&label=VS%20Code%20Marketplace)](https://marketplace.visualstudio.com/items?itemName=opencode.vscode-acp)
...
![OpenCode ACP Screenshot](assets/screenshot.png)
...
- **[OpenCode](https://github.com/anthropics/opencode)** — `go install github.com/anthropics/opencode@latest`
...
3. Search for "OpenCode ACP"
4. Click Install

### From VSIX

1. Download the `.vsix` file from [Releases](https://github.com/anthropics/vscode-acp/releases)
2. In VS Code: `Extensions` → `...` → `Install from VSIX...`

## Usage

1. Click the **OpenCode** icon in the Activity Bar (left sidebar)
...
```bash
# Clone the repo
git clone https://github.com/anthropics/vscode-acp.git
cd vscode-acp
...
**[Report a Bug](https://github.com/anthropics/vscode-acp/issues)** · **[Request a Feature](https://github.com/anthropics/vscode-acp/issues)**
